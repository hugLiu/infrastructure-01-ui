            ...
            <table class="table table-bordered table-hover vue-table template-table" style="table-layout:fixed;word-wrap:break-word;">
                <thead>
                    <tr>
                        ...
                        <th v-for="(f, index) of _data.fields" class="vue-table-th vue-table-cell-field text-ellipsis" @click="sort(index, $event)" v-if="f.visible" :title="f.title">
                            <div v-html="f.title" style="display: inline-block;"></div>
                            <div style="position: absolute;top: 30%;right: 0;">
                                <div v-if="f.sortable" style="display: inline-block;">
            ...
            sort(fieldIndex, event) {
                ...
                if (this.onsort) {
                    if (this.id) {
                        ...
                        ); // invoke common function return additional info
